  ...
  return (
    <div className="main-section py-4">
      <div className="header-section">
        ...
        <div className="button-section">
          ...
          <div className="map-dash flex justify-center items-center">
            ...
            {/* </div> */}
            {/* <div className="btn2"> */}
            <img src={category} alt="category" className="active" />{" "}
          </div>
      ...
      <div className="listitems py-3 flex  justify-start gap-x-3 ">
        {/* <div>helo</div>    */}
        <div>
          <Button value={"Shirt"} icon={crosssign} flex="flex" alignItems={"center"} flexDirection="row-reverse" />
        </div>
        <div>
          <Button value={"Kurti"} icon={crosssign}  flex="flex" alignItems={"center"} flexDirection="row-reverse"/>
        </div>
